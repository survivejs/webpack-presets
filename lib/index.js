...
function evaluate(_ref) {
  ...
  var commonConfig = rcConfiguration.common[target.split(':')[0]] || {};
  var paths = (0, _resolve_paths2.default)(_path2.default.join(__dirname, '..'), Object.assign({}, rcConfiguration.paths, commonConfig.paths, parsedEnv.paths));
